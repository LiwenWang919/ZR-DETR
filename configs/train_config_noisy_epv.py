...
train_dataset = CocoDetection(
    img_folder="/media/Storage3/wlw/Relation-DETR/datasets/EP_Fetal_S_Detection",
    ann_file="/media/Storage3/wlw/Relation-DETR/datasets/EP_Fetal_S_Detection/train_noisy.json",
    transforms=presets.detr,  # see transforms/presets to choose a transform
    train=True,
)
test_dataset = CocoDetection(
    img_folder="/media/Storage3/wlw/Relation-DETR/datasets/EP_Fetal_S_Detection",
    ann_file="/media/Storage3/wlw/Relation-DETR/datasets/EP_Fetal_S_Detection/test.json",
