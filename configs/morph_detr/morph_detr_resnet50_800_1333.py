...
from models.bricks.morphology_transformer import (
    MorphologyTransformer,
    MorphologyTransformerDecoder,
    MorphologyTransformerDecoderLayer,
    MorphologyTransformerEncoder,
    MorphologyTransformerEncoderLayer,
)
...
transformer = MorphologyTransformer(
    encoder=MorphologyTransformerEncoder(
        encoder_layer=MorphologyTransformerEncoderLayer(
            embed_dim=embed_dim,
            n_heads=num_heads,
            dropout=0.0,
    ...
    decoder=MorphologyTransformerDecoder(
        decoder_layer=MorphologyTransformerDecoderLayer(
            embed_dim=embed_dim,
            n_heads=num_heads,
            dropout=0.0,
            activation=nn.ReLU(inplace=True),
