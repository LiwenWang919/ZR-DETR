...
train_dataset = CocoDetection(
    img_folder="/media/Storage1/wlw/restore/One_Stage_Fetus_Object_Detection_Code_v2/Dataset_Fetus_Object_Detection/Hospital_3/four_chamber_heart",
    ann_file="/media/Storage3/wlw/Relation-DETR/datasets/fetus_annotations_coco/4C/c3/train/annotation_noisy.json",
    transforms=presets.detr,  # see transforms/presets to choose a transform
    train=True,
)
test_dataset = CocoDetection(
    img_folder="/media/Storage1/wlw/restore/One_Stage_Fetus_Object_Detection_Code_v2/Dataset_Fetus_Object_Detection/Hospital_3/four_chamber_heart",
    ann_file="/media/Storage3/wlw/Relation-DETR/datasets/fetus_annotations_coco/4C/c3/test/annotation.json",
