...
train_dataset = CocoDetection(
    img_folder="/media/Storage3/wlw/Relation-DETR/datasets/FUSAD/train/images",
    ann_file="/media/Storage3/wlw/Relation-DETR/datasets/FUSAD/train_noisy.json",
    transforms=presets.detr,  # see transforms/presets to choose a transform
    train=True,
)
test_dataset = CocoDetection(
    img_folder="/media/Storage3/wlw/Relation-DETR/datasets/FUSAD/test/images",
    ann_file="/media/Storage3/wlw/Relation-DETR/datasets/FUSAD/test.json",
